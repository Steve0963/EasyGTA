class Pointers:
    ...
    Lookback_Ptr = '58 8A 0D ?? ?? ?? ?? 8A 15 ?? ?? ?? ??'  # 0x563e54 58 8A 0D ?? ?? ?? ?? 8A 15 ?? ?? ?? ??
    ...
    TextMenu_Ptr = "0F 95 05 ?? ?? A7 02 E8 ?? ?? E7 FF 84 C0 0F 84 25 01 00 00"  # 0x195FF5  0F 95 05 17 EF A7 02 E8 F8 88 E7 FF 84 C0 0F 84 25 01 00 00
    Faclity_Ptr = "48 8D 0D ?? ?? ?? ?? B2 01 E9 ?? ?? E3"  # 0x29BA8  48 8D 0D ?? ?? ?? ?? B2 01 E9 ?? ?? E3 00 ?? ?? 48 8B C4 48
    WeaponType_Ptr = "48 8D 0D ?? ?? ?? 01 4C 8B C3 89 45 20 E8"  # 0x2C6342
    Attribute_Ptr = "00 8A 0D ?? ?? A8 01 45 84 C0 74 0D 84 C9 75 09 40 84 F6 74"  # 0x10218E7 00 8A 0D 6F F4 A8 01 45 84 C0 74 0D 84 C9 75 09 40 84 F6 74
    Selector_Ptr = "00 39 2D ?? ?? ?? 01 41 0F ?? F0 7F 54 40 38"  # 0x1B8BBF 00 39 2D ?? ?? ?? 01 41 0F ?? F0 7F 54 40 38 2D ?? ?? ?? 01
    FirstPerson_Ptr = "22 8B 0D ?? ?? B5 01 85 C9 78 18 83 F8 04 74 0A 83 F9 04 75"  #22 8B 0D DE C1 B5 01 85 C9 78 18 83 F8 04 74 0A 83 F9 04 75
